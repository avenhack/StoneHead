...
/* My macros and  constants*/
#define HEAD_TAG 1
#define FRUIT_TAG 2
#define TICK_INITIAL 0.5
#define TICK_DECREMENT 0.05
#define SCORE_INCREMENT 10
#define FRUIT_SIZE 32
#define ENABLE_MUSIC "EnableMusic"
...
static Resource mediumResource =  { cocos2d::CCSizeMake(1024, 768),  "md"   };
